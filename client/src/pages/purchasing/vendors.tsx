...
import { PlusIcon, SearchIcon, FilterIcon, BuildingIcon } from "lucide-react";
...
export default function Vendors() {
  ...
  // Placeholder for when there are no vendors
  const vendorsPlaceholder = (
    <div className="flex flex-col items-center justify-center py-12">
      <div className="bg-neutral-100 rounded-full p-4 mb-4">
        <BuildingIcon className="h-8 w-8 text-neutral-400" />
      </div>
      ...
      <p className="text-neutral-500 mb-4 text-center max-w-md">
        Add your first vendor to start creating purchase orders and recording bills.
      </p>
      <Button>
    ...
    <>
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-neutral-500">Manage your supplier information</p>
        </div>
        <Button>
          <PlusIcon className="mr-2 h-4 w-4" />
          Add Vendor
                ...
                <tbody className="divide-y divide-neutral-200">
                  {vendors.map((vendor) => (
                    <tr key={vendor.id} className="text-sm">
                      <td className="py-4 text-neutral-600">{vendor.code}</td>
                      <td className="py-4 font-medium">{vendor.name}</td>
                      <td className="py-4 text-neutral-600">{vendor.contactPerson}</td>
                      <td className="py-4 text-neutral-600">{vendor.email}</td>
                      <td className="py-4 text-neutral-600">{vendor.phone}</td>
